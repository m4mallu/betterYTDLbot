class Translation(object):
    ...
    WELCOME_TEXT = "Hey.. <b>{}</b>\n\n1️⃣ <code>Currently supports single YouTube Urls, Bot will download the media, " \
                   ...
                   "download, add the required text in PRE_FILE_TXT filed</code>\n\n6️⃣ <code>Finally.. You can't use " \
                   "the bot without Authorization </code>🤪\n\n<b>For any queries: 👉 </b> <a " \
                   "href='https://t.me/space4renjith'>@Admin</a>\n\n<b>My code can be seen :</b>👉 " \
                   "<a href='https://github.com/m4mallu/betterytdlbot'>HERE</a> "
    ...
    NOT_AUTH_TXT = "<b>You are not Authorized</b> ☹️\n<code>Please contact </code><a " \
                   "href='https://t.me/space4renjith'>@admin</a> <code>to get an access to this bot</code> "
